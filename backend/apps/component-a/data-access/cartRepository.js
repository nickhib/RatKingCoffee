...
export async function getCart(req,res) {
  ...
  let cartItems = await db.all("SELECT ci.product_id, ci.quantity, p.title,p.price, p.description, p.imageUrl FROM cart_items ci JOIN products p ON ci.product_id =p.id WHERE ci.cart_id=$cartId", {
        $cartId: cartId,
     })
